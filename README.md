...
* **Critério de comunidade:** A **Cor** dos vértices foi definida pela **Classe de Modularidade**, separando os clusters de páginas que têm alta densidade de links internos (comunidades temáticas).
